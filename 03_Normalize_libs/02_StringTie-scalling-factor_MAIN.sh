...
BFL=/domus/h1/luisleal/MYPROJ/3_DosageCompensation_LS/Scripts_NEW/03_Normalize_libs/StringTie_files_list.txt

#input file with counts per gene
CPG=/crex/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/03_Normalized_libs/gene_count_matrix.csv

#results folder	
RR=/crex/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/03_Normalized_libs	
