...
#v results folder
results_dir <- "/crex/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/03_Normalized_libs"
...
setwd("/domus/h1/luisleal/MYPROJ/3_DosageCompensation_LS/Scripts_NEW")
...
setwd("/crex/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/02_Assign_genes_to_chromosome")
...
setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_202_S48/stringtie_2")
stringtie202 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie202)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_203_S49/stringtie_2")
stringtie203 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie203)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_204_S34/stringtie_2")
stringtie204 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie204)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_205_S35/stringtie_2")
stringtie205 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie205)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_210_S51/stringtie_2")
stringtie210 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie210)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_211_S52/stringtie_2")
stringtie211 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie211)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_212_S36/stringtie_2")
stringtie212 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie212)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_213_S53/stringtie_2")
stringtie213 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie213)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_218_S55/stringtie_2")
stringtie218 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie218)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_219_S56/stringtie_2")
stringtie219 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie219)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_220_S57/stringtie_2")
stringtie220 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie220)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_221_S58/stringtie_2")
stringtie221 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie221)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_226_S59/stringtie_2")
stringtie226 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie226)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_227_S38/stringtie_2")
stringtie227 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie227)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_233_S60/stringtie_2")
stringtie233 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie233)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_234_S61/stringtie_2")
stringtie234 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie234)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P5052_235_S62/stringtie_2")
stringtie235 <- read.delim("STAR.Aligned.out.gene_abund.tab", header = TRUE, sep = "\t")
head(stringtie235)

setwd("/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/00_data_mirror_Lars/2e_STAR/P7553_325_S10/stringtie_2")
